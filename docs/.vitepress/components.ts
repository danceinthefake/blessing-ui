...
export const groups: { title: string; items: Entry[] }[] = [
  {
    ...
    items: [
      ...
      { name: "BlessPaletteToggle", slug: "palette-toggle", text: "Accent palette swatches" },
      { name: "BlessWatermark", slug: "watermark", text: "Giant faint word behind a block" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "BlessCollapsible", slug: "collapsible", text: "`<details>` based" },
      {
        name: "BlessAccordion",
        slug: "accordion",
        text: "Collapsibles, one open at a time",
        also: ["BlessAccordionItem"],
      },
