...
Fills use `accent`; text — the active nav item, links, selected rows — uses `accent-text`, a darker cut of the same hue that passes 4.5:1 on white.

| Palette   | Petal                                                                                                                  | Accent    | As text   | Note                                                                                               |
| --------- | ---------------------------------------------------------------------------------------------------------------------- | --------- | --------- | -------------------------------------------------------------------------------------------------- |
| `megumi`  | <span style="display:inline-block;width:14px;height:14px;background:#e85078;transform:skewX(-10deg)"></span> `#e85078` | `#e85078` | `#b63c5c` | top petal — the default, no attribute needed                                                       |
...
| `izumi`   | <span style="display:inline-block;width:14px;height:14px;background:#4090d0;transform:skewX(-10deg)"></span> `#4090d0` | `#4090d0` | `#3270a2` | lower-right petal — sky blue                                                                       |
| `michiru` | <span style="display:inline-block;width:14px;height:14px;background:#b878b0;transform:skewX(-10deg)"></span> `#b878b0` | `#b878b0` | `#8c5b86` | lower-left petal — mauve                                                                           |
| `eriri`   | <span style="display:inline-block;width:14px;height:14px;background:#c8e018;transform:skewX(-10deg)"></span> `#c8e018` | `#7f9600` | `#627300` | left petal — `#c8e018` is too pale to carry white, so it becomes `accent-soft` and the ink darkens |
| `tomoya`  | <span style="display:inline-block;width:14px;height:14px;background:#5870f8;transform:skewX(-10deg)"></span> `#5870f8` | `#5870f8` | `#4c60d5` | the founder's — indigo, not on the mark                                                            |
...
`--bless-color-accent`, `-accent-soft`, `-accent-2`, `-accent-text`, `-badge`, `-chart-1` — plus a dark-mode `accent-text` where the accent alone doesn't reach 4.5:1 on dark greys (Megumi, Utaha, Tomoya). Override any of them after `tokens.css` to tune a palette.
