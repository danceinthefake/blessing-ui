...
| Geometry | `--bless-lean`, −10°: upright at rest, taken on attention; big type and the mark lean always. One [shape](./conventions#shape): the upright square plate; the teardrop only in the mark | every label, field, switch and chip; every petal of the mark                               |
